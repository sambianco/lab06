...
public final class TestSocialNetworkUser {
    ...
    public static void main(final String... args) {
        ...
        final SocialNetworkUser<User> dwashington = new SocialNetworkUserImpl<>("Danzel", "Washington", "dwashington", 59);
        final SocialNetworkUser<User> mgladwell = new SocialNetworkUserImpl<>("Malcom", "Gladwell", "mgladwel", 51);
